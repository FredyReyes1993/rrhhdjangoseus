...
const opcionesDepartamentos = {
  ...
  const departamento = document.getElementById('id_departamento_dpi');
  const municipio = document.getElementById('id_municipio_dpi');
  ...
  departamento.addEventListener('change', () => {
    ...
    const opciones = opcionesDepartamentos[departamento.value];
