...
const opcionesDepartodom = {
  ...
  const deptodom = document.getElementById('id_depto_dom');
  const munidom = document.getElementById('id_muni_dom');

  // escuchar los cambios en la lista de departamento
  deptodom.addEventListener('change', () => {
    ...
    const opciones = opcionesDepartodom[deptodom.value];
